...
<div class="container-fluid" id="box-loading">
    <div class="box-loading-sub">
        <div class="vbox-preloader">
            <div class="sk-wave">
                <div class="sk-rect sk-rect1" style="background-color: rgb(203, 154, 0);"></div>
                <div class="sk-rect sk-rect2" style="background-color: rgb(203, 154, 0);"></div>
                <div class="sk-rect sk-rect3" style="background-color: rgb(203, 154, 0);"></div>
                <div class="sk-rect sk-rect4" style="background-color: rgb(203, 154, 0);"></div>
                <div class="sk-rect sk-rect5" style="background-color: rgb(203, 154, 0);"></div>
            </div>
        </div>
    </div>
</div>
                                        ...
                                        <ul class="minicart-product-list">
                                            ...
                                            if (isset($_SESSION['gio_hang']))
                                                foreach ($_SESSION['gio_hang'] as $id_sp => $sl) {
                                                    ...
                                                    <li>
                                                        <a href="?ctrl=Product<?php echo '&id=' . $id_sp ?>"
                                                        ...
                                                        <div class="minicart-product-details">
                                                            ...
                                                            <span>
                                                    <?= $total_new > 0 ? currency_format($total_new) . " x " . $sl : currency_format($total_old) . " x " . $sl ?>
