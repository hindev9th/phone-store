        ...
        public function __construct()
        {
            ...
            switch ($act) {
                case 'search':
                    ...
                    $data = $this->Model->fetch("select * from don_hang where ma_dh like '%$sr%'  OR ma_sp like '%$sr%' OR ten_sp like '%$sr%' AND id_tinh_trang = 5 order by thoi_gian_dh desc limit 25");
                    break;
                case 'select':
